...
data class GrimRegionProfile(val regionName: String, val dominantPhenomenon: String, val rulingFaction: String, val bossName: String, val ritualName: String, val ecosystem: String, val endingBias: String)
...
object GrimLoreCatalogues {
    val regions = listOf(
        GrimRegionProfile("Wybrzeże Północne", "Mgła", "Zakon Świtu", "Prorok Morskiej Mgły", "Rytuał Trzech Faleń", "zimne klify, porty, wraki, latarnie", "wzmacnia_zakonczenie_mgly"),
        GrimRegionProfile("Serce Krainy", "Odbicie", "Trybunał", "Lustrzany Król", "Rytuał Siedmiu Zwierciadeł", "miasto-katedra, sale sądowe, archiwa", "wzmacnia_zakonczenie_lustra"),
        GrimRegionProfile("Równiny Koronne", "Krew", "Gildia", "Awatar Krwi", "Rytuał Czerwonej Żniwy", "urodzajne pola, huty, kanały krwi", "wzmacnia_zakonczenie_krwi"),
        GrimRegionProfile("Pogranicze Stepowe", "Rozdarcie", "Bractwo Cienia", "Demiurg Symetrii", "Rytuał Pustego Trotu", "step, kurhany, szlaki najazdów", "otwiera_zakonczenie_rozdarcia"),
        GrimRegionProfile("Południowe Ruiny", "Pełnia", "Zakon Świtu", "Złoty Strażnik", "Rytuał Zszycia Dnia", "ruiny świątyń, popiół, echa hymnów", "zamyka_lub_lamie_odkupienie"),
        GrimRegionProfile("Góry Południowe", "Absolut", "Trybunał", "Awatar Pełni", "Rytuał Ostatniej Wysokości", "lodowe przełęcze, twierdze, cisza", "wzmacnia_absolut"),
        GrimRegionProfile("Ziemie Dzikie", "Mgła", "Brak stałej władzy", "Bestia Rozdarcia", "Rytuał Pierwotnego Kręgu", "las, łowy, głód, stare runy", "otwiera_zakonczenie_absolutu")
    )
    val factions = listOf(
