...
object ExpandedContentSeeder {
    fun seed(seed: Int = 21) {
        ...
        QuestSystem.register(
            QuestEntry(
                id = "quest_magdeburg_delivery_letters",
                title = "Carry Sealed Letters",
                description = "A sealed bundle of letters must reach trusted hands in Magdeburg.",
                cityId = "magdeburg",
                originType = QuestOriginType.CITY_EVENT,
                originRefId = "evt_magdeburg_guild_audit",
                rewardGold = 60,
