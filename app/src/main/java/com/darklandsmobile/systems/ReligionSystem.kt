...
import com.darklandsmobile.core.Religion.DivineFavor
import com.darklandsmobile.core.Religion.SaintCatalogue
...
object ReligionSystem {
    ...
    fun pray(saintId: String, shrineType: ShrineType): String {
        val saint = SaintCatalogue.all().firstOrNull { it.id == saintId }
            ?: return "Nieznany swiety: $saintId"
    ...
    fun getSaint(saintId: String) = SaintCatalogue.all().firstOrNull { it.id == saintId }
