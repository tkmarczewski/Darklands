...
import com.darklandsmobile.core.CityHubViewData
import com.darklandsmobile.core.CityVisual
import com.darklandsmobile.core.PlayerState
import com.darklandsmobile.core.QuestCardViewData

object VisualContentSystem {
    private val visuals = mapOf(
        "magdeburg" to CityVisual("magdeburg", "Magdeburg", "city_magdeburg_docks", "emblem_eagle", "Busy river trade, suspicious alleys, restless guild politics."),
