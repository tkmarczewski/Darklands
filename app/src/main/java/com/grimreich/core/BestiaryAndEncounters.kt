...
enum class EnemyType {
    ...
    POSSESSED_STATUE, // TO BE CHECKED
    FALLEN_PRIEST, // TO BE CHECKED
    MASKED_IMPOSTOR, // TO BE CHECKED
    SILENT_GUARDIAN, // TO BE CHECKED
    RAVEN_ASSASSIN, // TO BE CHECKED
    ARCH_RITUALIST, // TO BE CHECKED
    CEILING_CRAWLER, // TO BE CHECKED
    GHOSTLY_SENTINEL, // TO BE CHECKED
    MIND_REFLECTION, // TO BE CHECKED
    INK_NIGHTMARE, // TO BE CHECKED
    ECTOPLASMIC, // TO BE CHECKED
    VOID_WOLF, // TO BE CHECKED
    PARADOX_HUNTER, // TO BE CHECKED
    MUTANT_GHOUL, // TO BE CHECKED
    VAMPIRE_MONK, // TO BE CHECKED
    GOLDEN_COLOSSUS, // TO BE CHECKED
    DARK_RIDER, // TO BE CHECKED
    DREAM_WRAITH, // TO BE CHECKED
    HIDDEN_DEMON, // TO BE CHECKED
    BLOOD_CURSE, // TO BE CHECKED
    BLOOD_WRAITH, // TO BE CHECKED
