...
import com.grimreich.systems.BossBattleSystem
import com.grimreich.systems.BossState
...
class EndgameActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        fun isEligible(req: com.grimreich.systems.EndgameRequirements): Boolean {
            ...
            setOnClickListener {
                ...
                if (q != null) {
                    ...
                    gs.reputation.city.keys.firstOrNull()?.let { key ->
                        val currentReputation = gs.reputation.city[key] ?: 0
                        gs.reputation.city[key] = (currentReputation + q.rewards.reputationBonus)
                            .coerceIn(-100, 100)
                    }
