...
class GrimFullSuiteTest {
    ...
    @Test fun builders_cover_empty_defaults() {
        ...
        val chronicle = GrimBuilders.emptyWorldChronicle("Z")
    ...
    @Test fun engine_supports_full_lifecycle() {
        ...
        assertNotNull(engine.queryReligion("Cult"))
        assertNotNull(engine.queryArtifact("Relic"))
        assertNotNull(engine.queryAvatar())
        assertNotNull(engine.queryExpedition("Expedition"))
        assertNotNull(engine.queryCollapse())
        assertNotNull(engine.queryHistory("History"))
        assertNotNull(engine.queryChronicle("Chronicle"))
    }
    ...
    @Test fun generators_cover_full_content_flow() {
        ...
        val loot = LootRoller().roll(listOf("x"), OtherSideReward(1,1,1), 3)
