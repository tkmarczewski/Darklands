...
import com.darklandsmobile.core.TerrainType
...
class CataloguesAndWorldTest {
    ...
    @Test
    fun `world map is fully connected from magdeburg`() {
        CityCatalogue.seedSprint1()
        WorldMap.seedStage1()
    ...
    fun `terrain links are assigned for stage 1 routes`() {
        ...
        assertEquals(TerrainType.ROAD, WorldMap.terrainBetween("magdeburg", "hamburg"))
